...
prank.login(token="masukkan token kalian")
prank.loginResult()
...
Bots=[mid,"u4a59a856f5a1f7125d343675daabed4a"]
admin=["u4a59a856f5a1f7125d343675daabed4a"]
...
wait = {
    ...
    #'leaveRoom':True,
    'autoAdd':True,
    'message':"""THANKS FOR ADD ME\n\nhttp://github.com/AdheBoli/simi""",
    "lang":"JP",
    "comment1":"❂•••••••••••••••••••••••••❂\n                  https://www.kumandroid.ml\n『ঔৣ͜͡☠⃢H€π¶B0T ૮૨εω☠⃢ #ঔৣ』",
    "likeOn":True,
    "alwaysRead":True,
    "simiSimi":True,
}
    ...
    try:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True: 
                ...
                prank.sendText(op.param1, "Halo " + xname + "THANKS FOR ADD ME\n\n im bot protect line simi http://github.com/AdheBolo/simi")
                prank.sendText(op.param1, "++ADD OFFICIAL KAMI++")
                c = Message(to=op.param1, from_=None, text=None, contentType=13)
                c.contentMetadata={'mid':'u4a59a856f5a1f7125d343675daabed4a'}
                prank.sendMessage(c)
#--------------------------------------------------------
	    if mid in op.param3:
			...
			prank.updateGroup(G)
			prank.sendText(op.param1,"THANKS TO INVITE ")
                else:
			...
			G.preventJoinByTicket = True
			prank.updateGroup(G)
			prank.sendText(op.param1,"LUMAJANG SELFBOTS PROTECT LINE")
		    else:
                        prank.rejectGroupInvitation(op.param1)
        ...
        if op.type == 13:
            ...
            prank.sendText(op.param1,"Thanks" + "@"+xname+ "\nLUMAJANG SELFBOTS PROTECT LINE" + datetime.today().strftime('\n───────────\n⏰(%H:%M:%S)'))
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':'u4a59a856f5a1f7125d343675daabed4a'}
            prank.sendMessage(c)
...
#----------------------------------------------------------------------------
            ...
            if msg.contentType == 16:
                ...
                prank.sendText(msg.to,"ADA TOILET GAK?")
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'uf2cd3e46cf9565c699b099429da882f8'}
                prank.sendMessage(msg)
                ...
                prank.sendText(msg.to,"CREATOR ON blog http://www.kumandroid.ml")
            elif "Simi@bye" in msg.text:
                if msg.toType == 2:
                    ginfo = prank.getGroup(msg.to)
                    try:
                        prank.sendText(msg.to,"BYE BYE KAKAK JANGAN kangen ya...🙏🙏")
              ...
              if msg.from_ in admin:
                ...
                for j in xrange(k+1):
                    ...
                    prank.sendMessage(msg) 
                    prank.sendText(msg.to,"HAY KAMU IKUT AKU YUK...AKU SANGE NIH :v")
                 ...
                 prank.sendMessage(msg)
                 prank.sendText(msg.to,"ini yah kontak kakak .. jelek amat kak kayak maling yang lagi viral 😂")
        if op.type == 55:
            try:
